...
# Inserisci le tue chiavi Binance in modo sicuro
os.environ['BINANCE_API_KEY'] = getpass('Inserisci la tua Binance API Key: ')
os.environ['BINANCE_API_SECRET'] = getpass('Inserisci la tua Binance API Secret: ')
